...
while system_on == True:
    ...
    while on_menu == True:
        ...
        if app_chosen == "Vulture Console":
            ...
            if null_fix == True:
                ...
                print("____________________________________________________SYSTEM SHUTDOWN____________________________________________________")
                print("")
    ...
    while on_vulture == True:
        ...
        if console_command == "s/Uninstall Unknown":
            apps_list.pop()
            print("Unknown deleted")
